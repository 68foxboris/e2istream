...
class TSIPHost(TSCBaseHostClass):
	...
	def showmenu0(self,cItem):
		...
		Cima4u_TAB = [
					...
					{'category':hst,'title': 'WWE','link':'http://cima4u.tv/category/%d9%85%d8%b5%d8%a7%d8%b1%d8%b9%d8%a9-%d8%ad%d8%b1%d8%a9-wwe/','mode':'30','page':1},
	...
	def showmenu1(self,cItem):
		hst='host2'
		img_=cItem['icon']
		Cima4u_films_Cat = [{'title': 'افلام عربي',  'link':'http://cima4u.tv/category/%d8%a7%d9%81%d9%84%d8%a7%d9%85-%d8%b9%d8%b1%d8%a8%d9%8a-arabic-movies/'},
							{'title': 'افلام اجنبي', 'link':'http://cima4u.tv/category/%d8%a7%d9%81%d9%84%d8%a7%d9%85-%d8%a7%d8%ac%d9%86%d8%a8%d9%8a-movies-english/'},
							{'title': 'افلام كرتون', 'link':'http://cima4u.tv/category/%d8%a7%d9%81%d9%84%d8%a7%d9%85-%d9%83%d8%b1%d8%aa%d9%88%d9%86-movies-anime-cartoon/'},
							{'title': 'افلام هندي',  'link':'http://cima4u.tv/category/%d8%a7%d9%81%d9%84%d8%a7%d9%85-%d9%87%d9%86%d8%af%d9%8a-indian-movies/'},
							]
	...
	def showitms_series(self,cItem):
		...
		self.addDir({'import':cItem['import'],'title':'Page '+str(page+1),'page':page+1,'category' : 'host2','link':url1,'icon':image,'mode':'31'})				
