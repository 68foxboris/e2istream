...
def getinfo():
	info_={}
	info_['name']='Arabseed.Tv'
	info_['version']='1.1 24/05/2019'
	info_['dev']='RGYSoft'
	info_['cat_id']='1'
	info_['desc']='أفلام و مسلسلات عربية و اجنبية'
	info_['icon']='https://www.arabseed.tv/themes/arabseed/img/logo-c.png'
	info_['recherche_all']='1'
	info_['update']='Fix Ramadan Serie Category'
	return info_
...
class TSIPHost(TSCBaseHostClass):
	def __init__(self):
		...
		self.MAIN_URL = 'https://www.arabseed.tv'
	...
	def showmenu1(self,cItem):
		...
		if gnr<2:
			...
			self.Arablionz_TAB = [
								{'category':hst,'title': 'مسلسلات رمضان 2019',    'mode':'30', 'url':'https://www.arabseed.tv/category/%D9%85%D8%B3%D9%84%D8%B3%D9%84%D8%A7%D8%AA-%D8%B1%D9%85%D8%B6%D8%A7%D9%86-2019'},
								{'category':hst,'title': 'برامج رمضان 2019',     'mode':'30', 'url':'https://www.arabseed.tv/category/%D8%A8%D8%B1%D8%A7%D9%85%D8%AC-%D8%B1%D9%85%D8%B6%D8%A7%D9%86-2019'},
								]		
			self.listsTab(self.Arablionz_TAB, {'import':cItem['import'],'icon':cItem['icon']})	
			
		elif gnr==3:			
			self.Arablionz_TAB = [
								{'category':hst,'title': 'مصارعه',          'mode':'30', 'url':'https://www.arabseed.tv/category/%D9%85%D8%B5%D8%A7%D8%B1%D8%B9%D9%87'},
								{'category':hst,'title': 'برامج تلفزيونية', 'mode':'30', 'url':'https://www.arabseed.tv/category/%D8%A8%D8%B1%D8%A7%D9%85%D8%AC-%D8%AA%D9%84%D9%81%D8%B2%D9%8A%D9%88%D9%86%D9%8A%D8%A9'},
								{'category':hst,'title': 'مسرحيات عربية',   'mode':'30', 'url':'https://www.arabseed.tv/category/%D9%85%D8%B3%D8%B1%D8%AD%D9%8A%D8%A7%D8%AA-%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9'},
								{'category':hst,'title': 'رياضه',           'mode':'30', 'url':'https://www.arabseed.tv/category/%D8%B1%D9%8A%D8%A7%D8%B6%D9%87'},
								]		
			self.listsTab(self.Arablionz_TAB, {'import':cItem['import'],'icon':cItem['icon']})	
	...
	def showitms(self,cItem):
		...
		for (url,image,inf,titre,desc) in data1:
			...
			if inf_data:
				desc1='Rate: \c0000??00'+inf_data[0]+' \\n'
				desc1=desc1+'\c00??????View: \c0000??00'+inf_data[1]+'\c00??????\\n'
	...
	def SearchResult(self,str_ch,page,extra):	
		url_='https://www.arabseed.tv/search?s='+str_ch+'&page='+str(page)
