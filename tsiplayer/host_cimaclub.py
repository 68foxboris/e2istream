...
def getinfo():
	...
	info_['update']='Add Ramadan 2019 Category to Series'
	return info_
...
class TSIPHost(TSCBaseHostClass):
	...
	def get_links(self,cItem): 	
		...
		#sts, data = secimaclublf.cm.getPage(URL)
		file = open('/tmp/test1_rgysoft.txt','w') 		 
		file.write('URL='+URL+'\n') 		
		sts, data = self.getPage(URL)
		file.write('sts='+str(sts)+'\n')	
		if data:
