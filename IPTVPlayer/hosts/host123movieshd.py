...
class GoMovies(CBaseHostClass):
    ...
    def listMain(self, cItem):
        ...
        if self.MAIN_URL == None:
            self.selectDomain()
        MAIN_CAT_TAB = [{'category':'list_filter_genre', 'title': 'Movies',    'url':self.getFullUrl('/movies/') },
                        {'category':'list_filter_genre', 'title': 'TV-Series', 'url':self.getFullUrl('/tv-series/')},
