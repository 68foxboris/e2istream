...
def gettytul():
    return 'https://www.altadefinizione01.cc/'

class Altadefinizione(CBaseHostClass):

    def __init__(self):
        CBaseHostClass.__init__(self, {'history':'altadefinizione01.cc', 'cookie':'altadefinizione01.cc.cookie'})
        ...
        self.MAIN_URL = 'https://www.altadefinizione01.cc/'
    ...
    def listMainMenu(self, cItem):
        printDBG("Altadefinizione.cc.listMainMenu")
