...
config.plugins.iptvplayer.IPTVDMMaxDownloadItem = ConfigSelection(default = "4", choices = [("1", "1"),("2", "2"),("3", "3"),("4", "4")])
...
config.plugins.iptvplayer.pin = ConfigText(default = "2470", fixed_size = False)
...
config.plugins.iptvplayer.possibleUpdateType       = ConfigSelection(default = "sourcecode", choices = [("sourcecode", _("with source code"))]) 
...
class ConfigMenu(ConfigBaseWidget):
    ...
    def fillConfigList(list, hiddenOptions=False):
        if hiddenOptions:
            ...
            list.append(getConfigListEntry("E2iStream auto start at Enigma2 start", config.plugins.iptvplayer.plugin_autostart))
