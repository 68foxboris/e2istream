...
class E2iPlayerWidget(Screen):
    ...
    if screenwidth and screenwidth == 1920:
        skin =  """
                    <screen position="center,center" size="1590,825" title="E2iStream %s">
        ...
        skin =  """
                    <screen position="center,center" size="1090,525" title="E2iStream %s">
            ...
            if self.spinnerEnabled and None != self.workThread:
                if self.workThread.isAlive():
                    ...
                    if self.hostName not in GetHostsList(fromList=True, fromHostFolder=False):
                        ...
                        message += _('\nThis host is not a integral part of the E2iStream plugin.\nIt is not supported by E2iStream team.')
        ...
        if url != '' and CDisplayListItem.TYPE_PICTURE == self.currItem.type:
            ...
            if recorderMode or isBufferingMode:
                ...
                if not os_path.isdir(destinationPath):
                    ...
                    errorTab.append(_("Please set valid %s in the %s configuration.") % (_("downloads location") if recorderMode else _("buffering location"), 'E2iStream'))
                else:
...
class IPTVPlayerLCDScreen(Screen):
    ...
    if summary_screenwidth >= 800 and summary_screenheight >= 480:
        skin = """
    <screen position="0,0" size="800,480" title="E2iStream">
        ...
        skin = """
    <screen position="0,0" size="480,320" title="E2iStream">
        ...
        skin = """
    <screen position="0,0" size="220,176" title="E2iStream">
        ...
        skin = """
    <screen position="0,0" size="132,64" title="E2iStream">
